    ...
    <div class="container-fluid">
      ...
      <div class="row g-4">
        ...
        <div class="col-lg-7">
          <div class="card mb-3">
            <div class="card-header d-flex justify-content-between align-items-center">
              <h5 class="mb-0">Politicas globales del servidor</h5>
            ...
            <div class="card-body" [formGroup]="policyForm">
              <div class="form-check form-switch mb-3">
                ...
                <label class="form-check-label" for="sendBackupOnDelete">
                  ...
                  <span class="d-block text-muted small">Envia un ZIP con sus certificados al borrar su cuenta.</span>
                </label>
              </div>
              ...
              <div class="form-check form-switch mb-3">
                ...
                <label class="form-check-label" for="requirePersonalEmail">
                  ...
                  <span class="d-block text-muted small">Exige registrar correo de respaldo al colaborador.</span>
                </label>
              </div>

              <button type="button" class="btn btn-primary" (click)="saveServerPolicy()" [disabled]="loadingPolicy || savingPolicy">
                <i class="fas fa-save me-1"></i>
                {{ savingPolicy ? 'Guardando politicas...' : 'Guardar politicas globales' }}
              </button>
            </div>
          </div>
